...
let Factory;
beforeAll(() => {
  Factory = require(globalThis.applicationPath('/application/table/factory/integration-policy-override-table-factory'));
});

describe('IntegrationPolicyOverrideTableFactory', () => {
