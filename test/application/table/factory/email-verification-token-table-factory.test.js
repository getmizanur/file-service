...
let Factory;
beforeAll(() => {
  Factory = require(globalThis.applicationPath('/application/table/factory/email-verification-token-table-factory'));
});

describe('EmailVerificationTokenTableFactory', () => {
