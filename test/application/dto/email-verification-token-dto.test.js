...
let EmailVerificationTokenDTO;
beforeAll(() => {
  EmailVerificationTokenDTO = require(path.join(projectRoot, 'application/dto/email-verification-token-dto'));
});

describe('EmailVerificationTokenDTO', () => {
  let dto;
  beforeEach(() => {
    dto = new EmailVerificationTokenDTO();
  });
